                ...
                <el-dialog title="添加角色" :visible.sync="dialogTable">
                    <el-form ref="form" label-width="120px" class="box_select">
                        ...
                        <el-form-item label="角色编码：">
                            ...
                            <el-select v-model="roleCode" clearable filterable allow-create placeholder="请选择">
                                <el-option
    ...
    export default {
        ...
        methods: {
                ...
                this.axios.get(url).then(res=>{
                    ...
                    if(res.data.code==200){
                        res.data.result.forEach((val,index)=>{
                            roleCheak.push(res.data.result[index].permissionId)
                        })
                        
                      this.cheakarr = [...roleCheak];
                    // console.log( this.cheakarr,55555)
                    }
                })
            ...
            updataPermission(){
                ...
                // let parms = [...this.getcheckedNode]
                console.log(parms,"数组")
